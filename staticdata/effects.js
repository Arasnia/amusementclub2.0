...
module.exports = [
    {
        ...
        id: 'cakeday',
        name: 'Cake Day',
        desc: 'Get +100 avocados in your daily for every claim you did',
        passive: true,
        animated: true
    }, {
        id: 'holygrail',
        ...
        desc: 'Get 10% avocados back from wins on auction',
        passive: true
    }, {
        id: 'cherrybloss',
...

    {
        ...
        use: async (ctx, user) => {
            ...
            user.exp += cost
            return { msg: `you got **${cost}** ${ctx.symbols.avocados} back`, used: true }
        }
    }
]
