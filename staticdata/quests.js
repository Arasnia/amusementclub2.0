    ...
    daily: [
        {
            ...
            reward: (ctx) => `**600** ${ctx.symbols.avocados} and **2** xp`
        }, {
            id: 'claim8',
            ...
            reward: (ctx) => `**1400** ${ctx.symbols.avocados} and **5** xp`
        }, {
            id: 'bid2',
            ...
            reward: (ctx) => `**1000** ${ctx.symbols.avocados} and **2** xp`
        }, {
            id: 'bid5',
            ...
            reward: (ctx) => `**2000** ${ctx.symbols.avocados} and **8** xp`
        }, {
            id: 'forge1',
            ...
            reward: (ctx) => `**500** ${ctx.symbols.avocados} and **1** xp`
        }, {
            id: 'forge2',
            ...
            reward: (ctx) => `**800** ${ctx.symbols.avocados}, **30** ${ctx.symbols.vial} and **2** xp`
        }, {
            id: 'forge3',
            ...
            reward: (ctx) => `**1000** ${ctx.symbols.avocados}, **40** ${ctx.symbols.vial} and **5** xp`
        }, {
            id: 'tag2',
            name: 'Tag 2 cards',
            desc: '',
            ...
            reward: (ctx) => `**400** ${ctx.symbols.avocados} and **2** xp`
        }, {
            id: 'tag4',
            name: 'Tag 4 cards',
            desc: '',
            ...
            reward: (ctx) => `**800** ${ctx.symbols.avocados} and **4** xp`
        }, {
            id: 'liq2',
            ...
            reward: (ctx) => `**1500** ${ctx.symbols.avocados}, **60** ${ctx.symbols.vial} and **3** xp`
        },
    ],
